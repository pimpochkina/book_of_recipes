...
from PyQt5.QtWidgets import QStackedWidget, QApplication, QWidget, QMainWindow, QLineEdit
...
class MainWindow(QMainWindow):
    ...
    def search_pageInit(self):
        ...
        self.found_recipe_list.itemClicked.connect(self.read_recipe(item))
    ...
    def mainInit(self):
        ...
        self.read_btn.clicked.connect(self.read_recipe)
